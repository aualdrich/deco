      ...
      {isAdding ? (
        ...
        >
          ...
          <div className="flex gap-2">
            <button
              type="submit"
              className="flex-1 rounded py-1.5 text-xs font-semibold uppercase tracking-widest bg-deco-gold text-deco-bg hover:opacity-90 transition-opacity"
            >
              Add
            </button>
            <button
              type="button"
              onClick={cancel}
              className="flex-1 rounded py-1.5 text-xs font-semibold uppercase tracking-widest bg-deco-raised text-deco-muted hover:text-deco-text border border-deco-border transition-colors"
            >
              Cancel
            </button>
          </div>
